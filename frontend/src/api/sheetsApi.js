...
async function parseJsonOrExplain(resp) {
  ...
  // If something returns HTML, make it obvious.
  if (ct.includes("text/html")) {
    throw new Error(
      "Proxy returned HTML (not JSON). Check your Cloudflare Worker URL, and ensure it is not protected by Access / authentication."
    );
  }
